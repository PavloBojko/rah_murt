                    ...
                    <div class="row no-gutters row-grid">
                        <div class="col-12">
                            <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                <img src="<?php echo $result['avatar'] ?>" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                <h5 class="mb-0 fw-700 text-center mt-3">
                                <?php echo $result['name'] ?>
                                    <small class="text-muted mb-0"><?php echo $result['position'] ?></small>
                                </h5>
                        ...
                        <div class="col-12">
                            <div class="p-3 text-center">
                                <a href="tel:<?php echo $result['tel'] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $result['tel'] ?></a>
                                ...
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo $result['adres'] ?>
                                </address>
                            </div>
                        </div>
                    </div>
